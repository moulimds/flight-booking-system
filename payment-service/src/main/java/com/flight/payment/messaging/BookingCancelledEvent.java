...
public class BookingCancelledEvent implements Serializable {
    ...
    public BookingCancelledEvent(Long bookingId, String bookingReference, Long flightId, String seatNumber, Long userId, BigDecimal fareAmount) {
        this(bookingId, bookingReference, flightId, seatNumber, userId, fareAmount, null, null, null);
    }

    public BookingCancelledEvent(Long bookingId, String bookingReference, Long flightId, String seatNumber, Long userId,
                                 BigDecimal fareAmount, BigDecimal refundAmount, BigDecimal cancellationFee, Integer refundPercentage) {
