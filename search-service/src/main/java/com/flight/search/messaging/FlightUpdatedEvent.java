...
public class FlightUpdatedEvent implements Serializable {
    ...
    public FlightUpdatedEvent(Long flightId, String flightNumber, String airline, String source, String destination,
