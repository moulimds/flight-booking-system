...
public class FlightCreatedEvent implements Serializable {
    ...
    public FlightCreatedEvent(Long flightId, String flightNumber, String airline, String source, String destination,
