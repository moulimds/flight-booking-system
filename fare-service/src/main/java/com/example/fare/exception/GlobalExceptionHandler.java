...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleFareNotFound(FareNotFoundException ex, HttpServletRequest request) {
        log.warn("Fare not found: {} at path {}", ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handleFareValidation(FareValidationException ex, HttpServletRequest request) {
        log.warn("Fare validation failed: {} at path {}", ex.getMessage(), request.getRequestURI());
        ErrorResponse error = ErrorResponse.builder()
                .timestamp(LocalDateTime.now())
                .status(HttpStatus.UNPROCESSABLE_ENTITY.value())
                .error("FARE_VALIDATION_FAILED")
                .message(ex.getMessage())
                .path(request.getRequestURI())
                .build();
    ...
    public ResponseEntity<ErrorResponse> handleOptimisticLock(ObjectOptimisticLockingFailureException ex, HttpServletRequest request) {
        ...
        ErrorResponse error = ErrorResponse.builder()
                ...
                .message("Fare was updated concurrently by another operation. Please retry.")
                .path(request.getRequestURI())
                .build();
